...
class struct_validation_result:
    ...
    def to_str(self):
        print("Success : " + str(self.success) + ", msg : " + self.msg + ", last_tb : " + self.last_tb + ", ids_name : " + self.ids_name + ", rule_name : " + self.rule_name)
        ...
        for ids_validation_item in ids_validation_result_list :
            if testsuite_item.getAttribute('name') == ids_validation_item.ids_name :
                ...
                if ids_validation_item.success is False : 
                    ...
                    testcase.setAttribute('id',testsuite_item.getAttribute('id')+'.'+str(cpt_test_in_testsuite))
